...
const TelecomPage = () => {
  const content = {
    title: 'Telecom and Network Industry',
    subtitle: 'Building the backbone of modern communication with robust solutions for 5G, networking, and cloud infrastructure.',
    sections: [
      {
        title: 'Connecting the World',
        description: 'We provide specialized engineering services for the telecom sector, helping build and optimize next-generation networks. Our expertise spans from wireless technologies like 5G to core network infrastructure.',
        image: 'Telecommunication tower with 5G antennas at sunset'
      },
      {
